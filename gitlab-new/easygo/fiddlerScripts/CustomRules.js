...
class Handlers
{
	...
	*/
	...
	// static var cus_rootPath: String = "C:\\Entrobus\\projects\\crawl\\20190214scrapy\\tt\\easygo\\"; // office laptop computer
	static var cus_rootPath: String = "D:\\entrobus\\projects\\crawls\\easygo\\"; // Peter's laptop computer

	static var debug_url: String = "toscrape.com";
	static var match_str: String = "c.easygo.qq.com/api/egc/heatmapdata";
	...
	static function OnBeforeRequest(oSession: Session) {
		...
		if ((null != gs_ReplaceToken) && ( -1 < oSession.url.indexOf(gs_ReplaceToken) )) {   // Case sensitive
		...
		// Peter writes the following on 20190329 to 20190404
		if ( oSession.fullUrl.Contains( match_str ) ){
			var cookies = oSession.oRequest["Cookie"];
			var datetime_obj = Handlers.get_date_time();
			var log_filename = [ "cookie_", datetime_obj.datetime, ".txt" ].join("");

			Handlers.SaveToLocalFile( cookies, [ cus_rootPath, "logs\\" ].join(""), log_filename );
		}
	}
	...
	*/
	...
	static function SaveToLocalFile( content: String, root_path: String, filename:String ) {
		// https://wxb-love.iteye.com/blog/2029776
		var date_obj = new Date();
