...
function _getProvinceByProvinceCode(provinceCode){
    for(var i in _provinceJson){
        var province = _provinceJson[i];
        if(province.item_code == provinceCode){
...
function _getCityByCityCode(cityCode){
    for(var i in _cityJson){
        var city = _cityJson[i];
        if(city.item_code == cityCode){
...
function _getCitysByProvinceCode(provinceCode){
    var citys = [];
    var provincePreCode = provinceCode.substring(0, 2);
    for(var i in _cityJson){
        var _city = _cityJson[i];
        var cityPreCode = _city.item_code.substring(0, 2);
        if(provincePreCode==cityPreCode){
            citys.push(_city);
        }
    }
...
function _getAreasByCityCode(cityCode){
    var areas = [];
    var cityPreCode = cityCode.substring(0, 4);
    for(var i in _areaJson){
        var _area = _areaJson[i];
        var areaPreCode = _area.item_code.substring(0, 4);
        if(cityPreCode==areaPreCode){
            areas.push(_area);
        }
    }
...
function _getAreaByAreaCode(areaCode){
    for(var i in _areaJson){
        var _area = _areaJson[i];
        if(_area.item_code == areaCode){
