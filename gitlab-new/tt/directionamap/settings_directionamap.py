...
SPIDER_NAME = "directionamap"

DEFAULT_REQUEST_HEADERS = {
	"Referer": "https://restapi.amap.com/v3/direction/driving",
}
...
ITEM_PIPELINES = {
	f'{SPIDER_NAME}.pipelines.DirectionamapPipeline': 300,
}

SAVE_EVERY_RESPONSE = True
# SAVE_EVERY_RESPONSE = False

BASE_URI = "https://restapi.amap.com/v3/direction/driving"
